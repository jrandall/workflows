...
steps:
  - id: "#lobSTR"
    run: { import: lobSTR-tool-streamable.cwl }
    inputs:
  ...
  - id: "#samsort"
    run: { import: samtools-sort-streamable.cwl }
    inputs:
  ...
  - id: "#samindex"
    run: { import: samtools-index-streamable.cwl }
    inputs:
  ...
  - id: "#allelotype"
    run: { import: allelotype-streamable.cwl }
    inputs:
